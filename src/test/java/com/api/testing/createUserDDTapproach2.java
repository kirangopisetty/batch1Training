...
public class createUserDDTapproach2 {
	...
	public Object[][] DDT() {
		...
		return new Object[][] {
			...
			{"John","male","john@rat.com","active"},
			{"Anderson","male","and@rat.com","active"},
			{"linda","female","linda@rat.com","inactive"},
			{"rachael","female","rachael@rat.com","inactive"}
		};
	}
